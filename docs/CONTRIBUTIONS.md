...
- Designed and implemented the full backend architecture (`app.py`). The Flask application, routing, request validation, error handling, and graceful degradation across all Azure services
